...
<body>
    ...
    <thead>
			...
			<c:forEach var="patientInjection" items="${listPatientInjection}">
				<tr>
					...
					<td>${patientInjection.status}</td>
					 <td><a href="editPatientInjection?dignosis_no=${patientInjection.dignosis_no}">Edit</a>
						 <a
						href="deletePatientInjection?dignosis_no=${patientInjection.dignosis_no}">Delete</a></td>
		...
		<h4>
			New Patient njection Registration <a href="newPatientInjection">here</a>
			</br>
